...
async function humidityFormatted(inputDate : any){
...
export { humidityLatestReadings, readHumidity, humidityLatest, updateHumidityDaily, updateHumidityMini, updateHumidity, humidityFormatted }
...
async function airTempFormatted(inputDate : any){
...
export { airTempLatestReadings, readAirTemp, airTempLatest, updateAirTempDaily, updateAirTempMini, updateAirTemp, airTempFormatted }